FROM docker-registry.tools.wmflabs.org/toolforge-php73-sssd-web:latest AS dependencies
# ===============================================
#  COMPOSER INSTALL
# ===============================================
...
FROM docker-registry.tools.wmflabs.org/toolforge-php73-sssd-web:latest AS base
# ===============================================
#  BASE IMAGE
# ===============================================
ENV COPYPATROL_ROOT=/app
...
RUN apt-get clean && \
    ...
    apt-get install --yes php7.3-xdebug && \
    apt-get clean && \
...
CMD [ "sh", "-c", "lighttpd -D -f /etc/lighttpd/lighttpd.conf" ]
